...
class TestTranscriptSequenceMethodsPy(unittest.TestCase):
    """ unit test methods of the Transcript class that rely on sequence
    """
    ...
    def test_get_position_on_chrom(self):
        ...
        for pos in range(self.gene.start, self.gene.end):
    ...
    def test_genomic_sequence(self):
        """ test that we can set genomic_sequence correctly
        """
        ...
        self.gene = self.construct_gene(start=0, end=10, exons=[(0, 4), (6, 10)],
            cds=[(2, 4), (6, 8)], strand='-')
        self.gene.cds_sequence = "AGGCTC"
        self.gene.genomic_sequence = gdna
        self.assertEqual(self.gene.cds_sequence, "AGGCTC")
    ...
    def test_genomic_sequence_expanded(self):
        """ test that setting genomic_sequence works correctly with extra sequence
        """
